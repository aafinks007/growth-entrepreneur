...
const ClientDetail = () => {
  ...
  useEffect(() => {
    const fetchClientAndProjects = async () => {
      ...
      // Fetch the projects belonging to this client
  ...
  if (loading) {
    return <div style={{ paddingTop: '140px', textAlign: 'center', color: 'var(--accent)', minHeight: '80vh' }}>Loading client details...</div>;
  }
  ...
  return (
    <div style={{ paddingTop: '140px', minHeight: '80vh' }}>
      <section className="container">
        ...
        >
          <Link to="/clients" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-secondary)', marginBottom: '2rem', transition: 'color 0.3s' }}>
          ...
          <h1 style={{ marginBottom: '0.5rem', color: 'var(--accent)' }}>{client.name}</h1>
        ...
        {projects.length > 0 ? (
          ...
          <div style={{ textAlign: 'center', color: 'var(--text-secondary)', marginTop: '4rem' }}>
            <p>No public projects assigned to this client yet.</p>
          </div>
        )}
      </section>
      <style>{`
